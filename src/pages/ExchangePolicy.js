        ...
        <div className="row">
          <div className="col-12">
            <div className="policy">
              ...
              <ul >
                <li className='fs-7'>Items must be returned within 28 days of receipt.</li>
                <li className='fs-7'>Items must be unworn, unwashed and unused with the original labels still attached.</li>
                <li className='fs-7'>Underwear and swimwear can only be returned if the hygiene seal has not been removed.</li>
                <li className='fs-7'>Shoes must be tried on indoors.</li>
              </ul>
              <p className='fs-7'>
              ...
              <h4 className='fs-6'>How to Return an Item</h4>
              <h5>Faulty Goods</h5>
              <p className='fs-7'>
